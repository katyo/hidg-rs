...
- [tokio-hidg](https://crates.io/crates/tokio-hidg) - async interface for [tokio](https://tokio.rs/) async runtime
- [async-hidg](https://crates.io/crates/async-hidg) - async interface for other async runtimes
